...
<div>
    <form wire:submit="register">
        ...
        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end mt-4">
            <a class="underline text-sm text-surface-mid-gray hover:text-surface-off-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand/50"
